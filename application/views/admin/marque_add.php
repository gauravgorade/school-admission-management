                        ...
                        <div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="<?php echo base_url();?>admin/marquee_view">Marque View</a>
                                    </li>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <?php  echo form_open_multipart('Marque/create_notice' ,'class="needs-validation" novalidate'); ?>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <input type="hidden" name="url"
                                                    ...
                                                    <label for="n_heading">Marque Heading</label>
