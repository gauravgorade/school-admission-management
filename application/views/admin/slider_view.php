                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
				 			    ...
				 			    <tr>
                                      ...
                                      <th><a href="<?php echo base_url()."admin/slider_edit/".$t_id;?>"      class="btn btn-primary btn-floating btn-sm">
  											<i class="ti-pencil-alt"></i></a>  &emsp;
  											<a  data="<?php echo base_url()."Slider/delete/".$t_id;?>" class="btn btn-secondary btn-google btn-floating  btn-sm _deleteslider">
