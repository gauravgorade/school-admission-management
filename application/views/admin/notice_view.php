        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">View homepage Notice  </h6>
                            <div class="table-responsive">
                                	<table class="table table-bordered table-striped mb-0" id="example22">
                                    <thead>
				 			    ...
				 			    <tr>
                                        ...
                                        <td> <?php echo substr( $row->n_heading,0,50); ?></td>
                                        <td> <?php echo substr( $row->n_link,0,100); ?></td>
                                        
                                       
                                      <th><a href="<?php echo base_url()."admin/notice_edit/".$t_id;?>"      class="btn btn-primary btn-floating btn-sm">
  											<i class="ti-pencil-alt"></i></a>   &emsp;
  											<a id="<?php echo $t_id; ?>" class="btn btn-secondary btn-google btn-floating  btn-sm _deletenotice">
  											<i class="ti-trash"></i>  </a> 
  								  	  </th>
                                             <td>
                                             <?php if ($status == 1){ ?>
                                            <a href="<?php echo base_url()."Notice/status/".$t_id."/0"?>">  
                                            <span class="btn btn-success btn-sm ">&emsp;Active&emsp;</span></a>  
                   							<?php } else {?>
                   						<a href="<?php echo base_url()."Notice/status/".$t_id."/1";?>">
    ...
    $("._deletenotice").click(function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: '<?php echo base_url().'index.php/Notice/delete_notice/'?>' + $t_id,
                    type: 'POST',
                    dataType: 'json',
